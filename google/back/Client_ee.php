 ...
 */
require_once CPA_URL_PATH . '/google/Auth/AssertionCredentials.php';
require_once CPA_URL_PATH . '/google/Cache/File.php';
require_once CPA_URL_PATH . '/google/Cache/Memcache.php';
require_once CPA_URL_PATH . '/google/Config.php';
require_once CPA_URL_PATH . '/google/Collection.php';
require_once CPA_URL_PATH . '/google/Exception.php';
require_once CPA_URL_PATH . '/google/IO/Curl.php';
require_once CPA_URL_PATH . '/google/IO/Stream.php';
require_once CPA_URL_PATH . '/google/Model.php';
require_once CPA_URL_PATH . '/google/Service.php';
require_once CPA_URL_PATH . '/google/Service/Resource.php';
...
class Google_Client
{
  ...
  const USER_AGENT_SUFFIX = "google/";
