...
require_once CPA_GOOGLE_PATH . 'Auth/AssertionCredentials.php';
require_once CPA_GOOGLE_PATH . 'Cache/File.php';
require_once CPA_GOOGLE_PATH . 'Cache/Memcache.php';
require_once CPA_GOOGLE_PATH . 'Config.php';
require_once CPA_GOOGLE_PATH . 'Collection.php';
include_once CPA_GOOGLE_PATH . 'Exception.php';
require_once CPA_GOOGLE_PATH . 'IO/Curl.php';
require_once CPA_GOOGLE_PATH . 'IO/Stream.php';
require_once CPA_GOOGLE_PATH . 'Model.php';
require_once CPA_GOOGLE_PATH . 'Service.php';
require_once CPA_GOOGLE_PATH . 'Service/Resource.php';
