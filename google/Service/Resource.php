...
require_once CPA_GOOGLE_PATH . 'Exception.php';
require_once CPA_GOOGLE_PATH . 'Utils.php';
require_once CPA_GOOGLE_PATH . 'Http/Request.php';
require_once CPA_GOOGLE_PATH . 'Http/MediaFileUpload.php';
require_once CPA_GOOGLE_PATH . 'Http/REST.php';
...
class Google_Service_Resource
{
  ...
  public function call($name, $arguments, $expected_class = null)
  {
    ...
    if (isset($parameters['postBody'])) {
      if ($parameters['postBody'] instanceof Wb_Google_Model) {
